...
public struct TargetHitData
{
    ...
    public Vector3 RepresentativeNormal;    //대표 히트 위치의 표면 법선
    public float ClosestDistance;           //시작 위치 기준 거리

    public TargetHitData(int hitCount, Vector3 representativePoint, Vector3 representativeNormal, float closestDistance)
    {
        ...
        RepresentativeNormal = representativeNormal;
